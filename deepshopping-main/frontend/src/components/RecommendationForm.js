...
function RecommendationForm() {
  ...
  const handleImageAnalysis = async () => {
    ...
    try {
      const response = await axios.post(
        "https://57b0-220-120-112-2.ngrok-free.app/api/analyze-image",
        formData,
        {
          headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("https://57b0-220-120-112-2.ngrok-free.app/api/recommend", {
  ...
  const handleTryOn = async (imageUrl, index) => {
    ...
    try {
      const response = await axios.post("https://57b0-220-120-112-2.ngrok-free.app/api/try-on", {
        image_url: imageUrl,
      });
